...
\begin{figure}[!hbt]
  \centering
  \includegraphics[width=0.7\textwidth]{Figures/MCstat/bin3.pdf}
...
The results computed fitting a data-like statistics ``cocktail'' MC sample are summarised for each $q^2$ bin in Table~\ref{tab:lim.MCstat.toy}.
...
For completeness the $F_\mathrm{L}$ variable is also measured with the \BKsPsip sample, obtaining a value $0.538 \pm 0.008\stat$ to be compared with the world-average value of $0.463^{+0.028}_{-0.040}\,\text{(stat+syst)}$.
...
% \label{sec:mistag}
The error on mistag fraction has been estimated using the control channel $B^0 \rightarrow K^{*0}(K^+\pi^-) J/\psi(\mu^+ \mu^-)$, in $q^2$ bin~4.
...
\begin{figure}[!hbt]
  \centering
  \includegraphics[width=0.5\textwidth]{Figures/BKG/bin2.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\textwidth]{Figures/FC/testGausFitRange_bin0.pdf}
  \includegraphics[width=0.4\textwidth]{Figures/FC/testGausFitRange_bin1.pdf}
  \includegraphics[width=0.4\textwidth]{Figures/FC/testGausFitRange_bin2.pdf}
  \includegraphics[width=0.4\textwidth]{Figures/FC/testGausFitRange_bin3.pdf}
  \includegraphics[width=0.4\textwidth]{Figures/FC/testGausFitRange_bin5.pdf}
  \includegraphics[width=0.4\textwidth]{Figures/FC/testGausFitRange_bin7.pdf}
  \includegraphics[width=0.4\textwidth]{Figures/FC/testGausFitRange_bin8.pdf}
