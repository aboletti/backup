...
\subsection{Test of scale-factor dependency on toy statistics}
\label{sec:fixSyst.test}

The procedure used to compute the systematic uncertainty due to the fixed parameters, as described above, relies on the assumption that the scale factors do not depend on the statistics of the pseudo-experiment used.
...
%% Since the systematic uncertainty was computed with a pseudo-experiment with a number of events 100 times larger than data, this test is performed with a set of pseudo-experiments with a statistics which is a multiple of 10, from 10 to 90, with respect to the statistics in data.
...
\begin{figure}[!hbt]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{Figures/FixSyst/fixP1_0.pdf} &
    \includegraphics[width=0.45\textwidth]{Figures/FixSyst/fixP5_0.pdf}
  \end{tabular}
...
\begin{figure}[!hbt]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.45\textwidth]{Figures/FixSyst/fixP1_8.pdf} &
    \includegraphics[width=0.45\textwidth]{Figures/FixSyst/fixP5_8.pdf}
  \end{tabular}
