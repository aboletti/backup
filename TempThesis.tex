\documentclass[12pt,oneside,a4paper,draft]{report}
...
%%% from the paper
\providecommand{\cPKst}{\ensuremath{\textrm{K}^\ast}\xspace}
\providecommand{\cPKstz}{\ensuremath{\textrm{K}^{\ast0}}\xspace}
\providecommand{\cPAKstz}{\ensuremath{\overline{\textrm{K}}{}^{\ast0}}\xspace}
...
\title{Measurement of the P5' angular observable of  the decay B0->K*mu+mu- at 8 TeV}
