...
%%%%% NEW COMMANDS
\newcommand{\eff}{\ensuremath{\textrm{eff}}\xspace}
...
\newcommand{\BtoKstmumuconjdecay}{\ensuremath{\PaBz\to\cPAKstz(\PKm \Pgpp) \Pgmp \Pgmm}\xspace}
...
\graphicspath{{./Note1/}{./Paper/}{./Master/}{./Figures/}}
...
%% \clearpage
\bibliography{Biblio,bib-master,bib-note,bib-paper}{}
