...
The of operators $\mathcal O_i^{(a)}$ for $i<7$ are equal to the $P_i$ defined in the Reference~\cite{Bobeth:1999mk}, while the other ones are defined accordingly to Reference~\cite{Altmannshofer:2008dz}:
\begin{align}
